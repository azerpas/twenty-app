/**
 * Credits to: {@link MetaMask <https://github.com/MetaMask/metamask-mobile>}
 * @author MetaMask <https://github.com/MetaMask>
 */
...
export default {
	...
	async setGenericPassword(password: string, type?: PasswordType) {
		...
		await Keychain.setGenericPassword('twenty-earn-user', encryptedPassword, { ...defaultOptions, ...authOptions });
